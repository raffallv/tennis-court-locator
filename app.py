...
APP_VERSION = "v17 (Nominatim-first geocoding + 15mi ZIP radius)"
...
ZIP_RADIUS_DEG = 0.22  # ~15 miles — 5mi and 10mi both came back empty for a ZIP known to have courts; splitting the difference toward the 25mi GPS radius that worked
